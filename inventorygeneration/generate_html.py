...
N = 2 
ACCESSION_URL_BASE = "https://y2.lib.uchicago.edu/accession/"
OBJECT_URL_BASE = "https://y2.lib.uchicago.edu/private/"
...
if __name__ == "__main__":
    ...
    reader = FileSystemArchiveReader(LONGTERM_ROOT, arkid)
    archive = reader.read()
    print(archive)
    # files = []
    # segments = []
    ...
    #                        "name contenturl premisurl accessions legalnotes adminnotes")\
